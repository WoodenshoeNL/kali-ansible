...
test_cmd "ldapx" "ldapx --version 2>/dev/null || ldapx -v 2>/dev/null"
test_cmd "bloodhound-python" "bloodhound-python -h"
test_cmd "bloodhound-ce-python" "bloodhound-ce-python -h"
